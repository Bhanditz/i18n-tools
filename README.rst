...
* Ensure that Last-Translator is always set when pulling from Transifex.
  If there are no reviewed translations, Transifex will not include that
  header, but our validate code requires it.
